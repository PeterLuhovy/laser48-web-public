...
const categories = [
  {
    ...
    items: [
      ...
      { question: "Musím sa registrovať?", answer: "Nie. Žiadna registrácia. Pošli výkres a my sa ozveme." },
  ...
  },
  {
    title: "Cena a platba",
    items: [
      { question: "Koľko to stojí?", answer: "Závisí od materiálu, hrúbky, počtu kusov, dĺžky rezu a termínu. Pošli výkres → cenovú ponuku dostaneš do 24 hodín." },
  ...
  },
  {
    ...
    items: [
      ...
      { question: "Robíte aj povrchové úpravy?", answer: "Áno. Mokré aj práškové lakovanie zabezpečujeme interne. Napíš nám a dohodneme sa." },
    ],
  },
  {
    ...
    items: [
      ...
      { question: "Čo ak mám reklamáciu?", answer: "Kontaktuj nás okamžite. Ak je chyba na našej strane: oprava/výmena zadarmo. Reklamácií máme < 0.5%." },
