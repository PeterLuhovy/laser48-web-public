...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { question: "Ako dodávate diely?", answer: "Kuriér (DPD, GLS, TopTrans) na celé územie Slovenska s doručením do 24 hodín od expedície. Osobný odber v Púchove zadarmo (Po–Pia 8:00–16:00). Trenčiansky a Žilinský kraj — vlastný rozvoz priamo k zákazníkovi, cca 1× týždenne." },
      { question: "Dodávate aj do Česka?", answer: "Áno. Kuriér do ČR (DPD, TopTrans), štandardne 1 pracovný deň po expedícii. Pri urgentných express zákazkách doručenie SK aj ČR do 24 hodín od expedície." },
