...
export const COMPANY = "LASER48";
export const HOURS_WEEKDAY = "7:00–19:00";
export const HOURS_SATURDAY = "7:00–13:00";
export const HOURS_SHORT = `Po–Pia ${HOURS_WEEKDAY}, So ${HOURS_SATURDAY}`;
export const WEB = "https://www.laser48.sk";
export const PARENT_COMPANY = "Luhovy Industries";
